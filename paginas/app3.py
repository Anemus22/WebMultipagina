...
#Contenido de pagina
st.title("Curso de Programación en C++")
...
st.warning("⚠️ Importante ejecutar flask en una terminal con el codigo = python c++.py desde la carpte Flask")